...
API_ID = int(environ.get('API_ID', '24926969'))
API_HASH = environ.get('API_HASH', '21d34ab214d83d543f555396cbeecf4e')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002042978606').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Streamplax:Ou7DZpz1bSV5juOv@cluster0.ctmx0e9.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002092187024'))
...
URL = "https://movies-corner.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://movies-corner.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movies-corner.onrender.com/".format(FQDN)
else:
    URL = "https://movies-corner.onrender.com/".format(FQDN)
